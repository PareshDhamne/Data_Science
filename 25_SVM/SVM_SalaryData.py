...
relationship: Relationship status (e.g., spouse, child, unmarried).
race: Ethnicity or racial background of the individual.
sex: Gender of the individual.
capitalgain: Capital gains earned.
capitalloss: Capital losses incurred.
hoursperweek: Number of hours worked per week.
native: Country of origin.
Salary: Target variable indicating whether the individual earns above or below a certain threshold.
"""
...
Salary = pd.read_csv('D:/12-SUPERVISED ALGORTIHM/SVM/Datasets_SVM(1)/SalaryData_Train (1).csv')
Salary.head()
...
'''
The solution leveraging Support Vector Machines (SVM) provides valuable insights into population density 
and income levels, enabling informed investment decisions for the construction firm in developing suburban infrastructure. 
By accurately assessing market dynamics, the firm can minimize the risk of losses and maximize profits, 
optimizing resource allocation and enhancing overall business profitability.
'''
