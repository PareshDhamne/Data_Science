...
forest=pd.read_csv("D:/12-SUPERVISED ALGORTIHM/SVM/Datasets_SVM(1)/forestfires.csv")
...
'''
The SVM-based forest fire prediction model improves emergency preparedness,
reduces property damage, and saves lives by accurately anticipating fire sizes and guiding resource allocation, 
leading to cost savings and enhanced public safety.
'''