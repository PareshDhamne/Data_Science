...
Business Problem:
    ...
    - Maximize:Increase sales for products by promoting groceries associations to enhance the overall customer. 
...
Benifits to the client:
    Leverage association rules from daily transactional data to optimize product placements, 
    tailor marketing strategies, and enhance customer satisfaction, thereby maximizing sales and 
    minimizing costs for the Departmental Store.
'''
##################################################################################
